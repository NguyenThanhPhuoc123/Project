                ...
                <div id="carousel-example-1z" class="carousel slide carousel-fade carousel-fade" data-ride="carousel">
                    ...
                    <div class="carousel-inner z-depth-1-half" role="listbox">
                        ...
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="./Content/imagetourdien/br.jpg" style="height: 400px;" alt=" First slide">
                        </div>
                        <!--/First slide-->
                        <!--Second slide-->
                        <div class="carousel-item">
                            <img class="d-block w-100" src="./Content/imagetourdien/br1.jpg" style="height: 400px;" alt="Second slide">
                        </div>
                        <!--/Second slide-->
                        <!--Third slide-->
                        <div class="carousel-item">
                            <img class="d-block w-100" src="./Content/imagetourdien/br7.jpg" alt="Third slide" style="height: 400px;">
                        </div>
